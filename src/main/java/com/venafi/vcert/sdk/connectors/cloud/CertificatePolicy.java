...
public class CertificatePolicy {
    ...
    private String name;
    //@SerializedName("systemGeneratedate") // todo: Go SDK uses this spelling, but server returns the one below
    ...
    Policy toPolicy() {
        ...
        Policy policy = new Policy()
                .allowedKeyConfigurations(new ArrayList<>())
                ...
                .dnsSanRegExs(addStartEndToCollection.apply(sanRegexes))
                .allowKeyReuse(keyReuse);
    ...
    void toZoneConfig(ZoneConfiguration zoneConfig) { // todo: rename to augmentZoneConfig or addToZoneConfig ?
