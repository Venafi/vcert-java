...
public class Is {
   ...
   * @return
   * @see <a href=
   *      "https://stackoverflow.com/questions/41637181/regex-pattern-with-unicode-doesnt-do-case-folding">SO</a>
   * @see <a href=
   *      "https://www.elastic.co/guide/en/elasticsearch/guide/current/case-folding.html">explanation</a>
